...
<div class="bg-white min-h-[calc(100vh-8rem)] rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300 p-8 lg:p-10 font-inter max-w-5xl mx-auto mb-10">
    ...
    <div class="mb-8 pb-5 border-b border-slate-100 flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold font-geist text-slate-800">Tambah Data Siswa</h2>
            <p class="text-sm text-slate-500 font-inter mt-1">Masukkan informasi siswa magang baru dengan lengkap dan benar.</p>
        </div>
    </div>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="jurusan" value="{{ old('jurusan') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/40 outline-none transition-all" placeholder="Contoh: Teknik Komputer dan Jaringan" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="pembimbing" value="{{ old('pembimbing') }}" class="w-full bg-white border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/40 outline-none transition-all" placeholder="Masukkan nama pembimbing">
                    </div>
                </div>
            </section>
